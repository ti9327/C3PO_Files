...
namespace GeneratedCommandStreams
{
    ...
    */
    ...
    const char STREAM_DEFAULTPOSE_CHAR_STREAM[] PROGMEM = "sC,19,0,1000,4096,333,0,4096,-333,0\nsC,18,0,1000,4096,333,0,4096,-333,0\nsC,16,0,1000,4447,333,0,4447,-333,0\nsC,17,0,1000,3745,333,0,3745,-333,0\nsC,22,0,1000,4096,333,0,4096,-333,0\nsC,21,0,1000,4096,250,0,4096,-250,0\n";
    const char STREAM_DEFAULTPOSE_CHAR_STREAM_LOOP[] PROGMEM = "";
    ...
    const char STREAM_PRESENTING_CHAR_STREAM_LOOP[] PROGMEM = "";
    ...
    const char STREAM_WAVE_CHAR_STREAM_LOOP[] PROGMEM = "";
    ...
    const char STREAM_TEST_CHAR_STREAM_LOOP[] PROGMEM = "";

    CommandStream setupStream = CommandStream(SETUP_CHAR_STREAM, 0);
    CommandStream stream_DefaultPose = CommandStream(STREAM_DEFAULTPOSE_CHAR_STREAM, 1000, STREAM_DEFAULTPOSE_CHAR_STREAM_LOOP, 0);
    CommandStream stream_Presenting = CommandStream(STREAM_PRESENTING_CHAR_STREAM, 10000, STREAM_PRESENTING_CHAR_STREAM_LOOP, 418);
    CommandStream stream_Wave = CommandStream(STREAM_WAVE_CHAR_STREAM, 7000, STREAM_WAVE_CHAR_STREAM_LOOP, 0);
    CommandStream stream_Test = CommandStream(STREAM_TEST_CHAR_STREAM, 5000, STREAM_TEST_CHAR_STREAM_LOOP, 0);    
